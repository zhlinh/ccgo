...
use crate::builder::toolchains::ohos::{OhosAbi, OhosSdkToolchain, DEFAULT_MIN_SDK_VERSION};
...
impl OhosBuilder {
    ...
    fn configure_cmake(
        ...
        cmake
            ...
            .user_cmake_files(ctx.cmake_user_files("ohos"))
    }
...
impl PlatformBuilder for OhosBuilder {
    ...
    fn clean(&self, ctx: &BuildContext) -> Result<()> {
        ...
        crate::utils::paths::clean_ccgo_build_platform(&ctx.ccgo_build_root, "ohos")?;
