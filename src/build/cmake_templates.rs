...
const TEMPLATE_TESTS_CMAKELISTS: &str =
    include_str!("../../cmake/template/Tests.CMakeLists.txt.in");
const TEMPLATE_BENCHES_CMAKELISTS: &str =
    include_str!("../../cmake/template/Benches.CMakeLists.txt.in");
const TEMPLATE_THIRD_PARTY_CMAKELISTS: &str =
    include_str!("../../cmake/template/ThirdParty.CMakeLists.txt.in");
const TEMPLATE_EXTERNAL_CMAKELISTS: &str =
    include_str!("../../cmake/template/External.CMakeLists.txt.in");
const TEMPLATE_EXTERNAL_DOWNLOAD: &str =
    include_str!("../../cmake/template/External.Download.txt.in");
const TEMPLATE_SRC_SUBDIR_CMAKELISTS: &str =
    include_str!("../../cmake/template/Src.SubDir.CMakeLists.txt.in");
...
fn write_templates(cmake_dir: &Path) -> Result<()> {
    ...
    write_file(
        ...
        TEMPLATE_ROOT_CMAKELISTS,
    )?;
    write_file(
        &template_dir,
        "Src.CMakeLists.txt.in",
        TEMPLATE_SRC_CMAKELISTS,
    )?;
    write_file(
        &template_dir,
    ...
    write_file(
        &template_dir,
        "Benches.CMakeLists.txt.in",
        TEMPLATE_BENCHES_CMAKELISTS,
    )?;
    write_file(
        &template_dir,
        "ThirdParty.CMakeLists.txt.in",
        TEMPLATE_THIRD_PARTY_CMAKELISTS,
    )?;
    write_file(
        &template_dir,
        "External.CMakeLists.txt.in",
        TEMPLATE_EXTERNAL_CMAKELISTS,
    )?;
    write_file(
        &template_dir,
        "External.Download.txt.in",
        TEMPLATE_EXTERNAL_DOWNLOAD,
    )?;
    write_file(
        &template_dir,
        "Src.SubDir.CMakeLists.txt.in",
        TEMPLATE_SRC_SUBDIR_CMAKELISTS,
    )?;
